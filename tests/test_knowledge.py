...
from coreason_validator.schemas.knowledge import KnowledgeArtifact, ArtifactType

def test_knowledge_artifact_minimal():
...
def test_knowledge_artifact_full():
...
def test_knowledge_artifact_missing_required():
...
def test_knowledge_artifact_invalid_type():
